...
| `metal > alternative`                  | `heavy metal > alternative metal`      | In other contexts, we treat `alternative metal` as a subgenre of `alternative`. But here, since the Magma user had `alternative` as a genre option and chose `metal` instead, we prioritize metal as the primary genre|
...
| `other > ambient`                      | `ambient/drone > ambient`              | Exclusive to Magma v1                                                                                                        |
